...
@section('content')
    <div class="max-w-4xl mx-auto px-4 py-6">
        <div class="mb-8">
            ...
            <h1 class="text-4xl font-bold text-gray-900 dark:text-white">Create New Schedule</h1>
            <p class="text-gray-600 dark:text-gray-400 mt-2">Define your availability for patient bookings</p>
        </div>
            ...
            <form action="{{ route('doctor.schedules.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="max_patients_per_day" id="max_patients_per_day" required
                            value="{{ old('max_patients_per_day', 10) }}" min="1" max="20"
                            class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-20">
                    ...
                    <div>
                        ...
                        <input type="number" name="consultation_fee" id="consultation_fee"
                            value="{{ old('consultation_fee') }}" min="0" step="0.01"
                            class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-20">
                ...
                <div>
                    ...
                    <textarea name="notes" id="notes" rows="4"
                        ...
                        class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-20">{{ old('notes') }}</textarea>
                    @error('notes')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
